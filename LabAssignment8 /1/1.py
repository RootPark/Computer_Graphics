...
def render():
    global gCamAng, gCamHeight, lightColorR, lightColorG, lightColorB, objectColorR, objectColorG, objectColorB
    ...
    lightColor = (lightColorR,lightColorG,lightColorB,1.)
    ...
    objectColor = (objectColorR,objectColorG,objectColorB,1.)
